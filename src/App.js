  ...
  render() {
    ...
    return (
      ...
      <nav className="navbar navbar-dark bg-primary sticky-top ">
        ...
        <a className="nav-link" rel="noopener noreferrer" href="https://github.com/sanjeevrajk/movie-list" target="_blank"  aria-label="GitHub">
      ...
      <div className="jumbotron jumbotron-fluid">
        <div className="container">
          ...
          <DebounceInput
              ...
              minLength={3}
              debounceTimeout={300}
              placeholder="Search a movie title,year or Director..."
              autoFocus
            />
            <span className="search_icon"> <i className="material-icons">search</i> </span>
            </div>
        </div>
